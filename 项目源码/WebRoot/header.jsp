...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">设备资源管理网</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                <li><a href="<%=basePath %>index.jsp">首页</a></li>
                 <li><a href="<%=basePath %>Device/frontlist">仪器设备</a></li> 
                <li><a href="<%=basePath %>Repair/frontlist">校准检修</a></li>
                <li><a href="<%=basePath %>BuyPlan/frontlist">购置计划</a></li>
                <li><a href="<%=basePath %>DataDraw/frontlist">资料图纸</a></li>
                <li><a href="<%=basePath %>SiteBase/frontlist">站点基本信息</a></li>
                <li><a href="<%=basePath %>SiteRun/frontlist">运行情况</a></li>
                <li><a href="<%=basePath %>Maintain/frontlist">维护情况</a></li>
